...
maxvalindex1 = max(index1_dict.values())
minvalindex1 = min(index1_dict.values())
maxtermindex2 = []
mintermindex2 = []
for k, v in index1_dict.items():
    if index1_dict[k] == maxvalindex1:
        maxtermindex2.append(k)
    elif index1_dict[k] == minvalindex1:
...
print("\nDocid with the largest max_tf in collection: %s" % max_tfdocid)

maxdoclendict = dict(doclst)
maxdoclendocid = max(maxdoclendict.items(), key=operator.itemgetter(1))[0]
print("\nDocid with the largest doc length in collection: %s" % maxdoclendocid)

print("Size of uncompressed index1: ",os.path.getsize("Index_v1_uncompressed.bin"))
print("Size of uncompressed index2: ",os.path.getsize("Index_v2_uncompressed.bin"))
print("Size of compressed index1: ",os.path.getsize("Index_v1_compressed.bin"))
print("Size of compressed index2: ",os.path.getsize("Index_v2_compressed.bin"))

print("Time to build uncompressed index1: ",end1-start1)
print("Time to build uncompressed index2: ",end2-start2)
print("Time to build compressed index1: ",end3-start3)
print("Time to build compressed index2: ",end4-start4)
